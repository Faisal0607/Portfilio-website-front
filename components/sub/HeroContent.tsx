    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center text-center md:text-start">
        <motion.div
          ...
          className="Welcome-box py-[8px] px-[7px] border border-[#7042f88b] opacity-[0.9] flex items-center mx-auto md:mx-0 justify-center md:justify-start"
        >
          <SparklesIcon className="text-[#7c56ef] mr-[10px] h-5 w-5" />
